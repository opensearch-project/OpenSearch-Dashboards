 ...
 */
export const findDocTableExpandedDocRowsIn = (expandedDocument) => {
 ...
 */
export const getExpandedDocRow = (docTableRowNumber, expandedDocumentRowNumber) => {
 ...
 * getExpandedDocRow(1, 0);
 */
export const getExpandedDocRowValue = (docTableRowNumber, expandedDocumentRowNumber) => {
 ...
 * getExpandedDocRow(1, 0);
 */
export const getExpandedDocRowFieldName = (docTableRowNumber, expandedDocumentRowNumber) => {
  return getExpandedDocRow(docTableRowNumber, expandedDocumentRowNumber)
    .find('td')
 ...
 */
export const selectIndexDatasetLanguage = (datasetLanguage, timeField) => {
 ...
 * @param {string}
 */
export const selectIndexDataset = (indexClusterName, indexName, datasetLanguage, timeField) => {
 ...
 */
export const verifyDocTableRowFilterForAndOutButton = (rowNumber, shouldExist) => {
 ...
 */
export const verifyDocTableFirstExpandedFieldFirstRowFilterForFilterOutExistsFilterButtons = (
  isEnabled
) => {
 ...
 * @param {string} expectedQueryHitsAfterFilterApplied expected number of hits in string after the filter is applied. Note you should add commas when necessary e.g. 9,999
 */
export const verifyDocTableFirstExpandedFieldFirstRowFilterForButtonFiltersCorrectField = (
  docTableRowNumber,
  expandedDocumentRowNumber,
  expectedQueryHitsWithoutFilter,
  expectedQueryHitsAfterFilterApplied
 ...
 * @param {string} expectedQueryHitsAfterFilterApplied expected number of hits in string after the filter is applied. Note you should add commas when necessary e.g. 9,999
 */
export const verifyDocTableFirstExpandedFieldFirstRowFilterOutButtonFiltersCorrectField = (
  docTableRowNumber,
  expandedDocumentRowNumber,
  expectedQueryHitsWithoutFilter,
  expectedQueryHitsAfterFilterApplied
 ...
 * @param {string} expectedQueryHitsAfterFilterApplied expected number of hits in string after the filter is applied. Note you should add commas when necessary e.g. 9,999
 */
export const verifyDocTableFirstExpandedFieldFirstRowExistsFilterButtonFiltersCorrectField = (
  docTableRowNumber,
  expandedDocumentRowNumber,
  expectedQueryHitsWithoutFilter,
  expectedQueryHitsAfterFilterApplied
