...
import { OpenSearchDashboardsRequest, ensureRawRequest, LegacyRequest } from './router';
...
export class AuthHeadersStorage {
  ...
  public set = (request: OpenSearchDashboardsRequest | LegacyRequest, headers: AuthHeaders) => {
