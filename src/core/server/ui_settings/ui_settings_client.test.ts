...
import { CURRENT_USER_PLACEHOLDER, CURRENT_WORKSPACE_PLACEHOLDER } from './utils';
...
describe('ui settings', () => {
  ...
  describe('#getAll()', () => {
    ...
    it(`workspace values set the setting undefined if workspace values don't exist but global values exist`, async () => {
      const defaults = {
        foo: {
          value: 'default',
          scope: 'workspace',
