...
export const mockOpenSearchService = opensearchServiceMock.create();
jest.doMock('./opensearch/opensearch_service', () => ({
...
const realOsdConfig = jest.requireActual('@osd/config');
