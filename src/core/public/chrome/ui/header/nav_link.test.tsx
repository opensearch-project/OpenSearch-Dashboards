...
describe('isActiveNavLink', () => {
  ...
  it('should return false if the appId is "data-explorer" and linkId is "explore"', () => {
    expect(isActiveNavLink('data-explorer', 'explore')).toBe(false);
  });

  it('should return true if the appId is "explore" and linkId is "explore"', () => {
    expect(isActiveNavLink('explore', 'explore')).toBe(true);
  });
