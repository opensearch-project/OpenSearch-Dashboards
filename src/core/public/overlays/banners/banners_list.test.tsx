...
describe('BannersList', () => {
  ...
  test('renders a list of banners', () => {
    ...
    expect(mount(<BannersList banners$={banners$} />).html()).toMatchInlineSnapshot(
      `"<div class=\\"osdGlobalBannerList\\"><div data-test-priority=\\"0\\" class=\\"osdGlobalBannerList__item\\"><h1>Hello!</h1></div></div>"`
    );
  });
  ...
  test('updates banners', () => {
    ...
    expect(component.html()).toMatchInlineSnapshot(
      `"<div class=\\"osdGlobalBannerList\\"><div data-test-priority=\\"1\\" class=\\"osdGlobalBannerList__item\\"><h1>First Banner!</h1></div><div data-test-priority=\\"0\\" class=\\"osdGlobalBannerList__item\\"><h1>Second banner!</h1></div></div>"`
    );
