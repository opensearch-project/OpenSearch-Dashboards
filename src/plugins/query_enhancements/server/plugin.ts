...
import { getPplLintRuleSettings, getTimeRangeHintSettings } from './ui_settings';
...
> {
  ...
  public async setup(
    ...
    core.uiSettings.register(getTimeRangeHintSettings(core.workspace.isWorkspaceEnabled()));
