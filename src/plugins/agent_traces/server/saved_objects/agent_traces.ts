...
export const agentTracesSavedObjectType: SavedObjectsType = {
  name: 'agentTraces',
  hidden: false,
  ...
  management: {
    ...
    getEditUrl(obj) {
      return `/management/opensearch-dashboards/objects/savedAgentTraces/${encodeURIComponent(
        obj.id
      )}`;
    },
    getInAppUrl(obj) {
      return {
        ...
        path: `/app/agentTraces/${obj.attributes.type}/#/view/${encodeURIComponent(obj.id)}`,
