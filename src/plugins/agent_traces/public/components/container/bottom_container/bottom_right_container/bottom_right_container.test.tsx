...
jest.mock('./resizable_vis_control_and_tabs', () => ({
  ResizableVisControlAndTabs: () => (
    <div data-test-subj="agentTraces-tabs-vis-style-panel">Agent Traces Tabs and Style Panel</div>
  ),
}));
...
jest.mock('../../../trace_auto_detect_callout', () => ({
  TraceAutoDetectCallout: () => <div data-test-subj="trace-auto-detect-callout">Auto Detect</div>,
}));
...
describe('BottomRightContainer', () => {
  ...
  it('should render content when flavor is traces', () => {
    mockUseDatasetContext.mockReturnValue({
      dataset: { timeFieldName: 'timestamp' } as any,
      isLoading: false,
      error: null,
  ...
  it('should render content when flavor is logs', () => {
    mockUseDatasetContext.mockReturnValue({
      dataset: { timeFieldName: 'timestamp' } as any,
      isLoading: false,
      error: null,
