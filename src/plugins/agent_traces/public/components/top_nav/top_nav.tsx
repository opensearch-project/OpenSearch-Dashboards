...
export const TopNav = ({ setHeaderActionMenu = () => {}, savedAgentTraces }: TopNavProps) => {
  ...
  // `overlays`). useOpenOnUrlMarker reads the marker, opens the flyout, and
  // strips it (cooldown / replaceState / cross-app + same-app handling live in
  // the hook). locationKey is the react-router location so same-app
  // (scoped-history) navigations — which don't emit a window `hashchange` —
  // re-check.
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    name: i18n.translate('agentTraces.topNav.savedSearchShortcut', {
      defaultMessage: 'Saved search',
    }),
    category: i18n.translate('agentTraces.topNav.searchCategory', {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    id: 'save_search',
    pluginId: 'agentTraces',
    name: i18n.translate('agentTraces.topNav.saveSearchShortcut', {
      defaultMessage: 'Save discover search',
    }),
    category: i18n.translate('agentTraces.topNav.editingCategory', {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    id: 'refresh_query',
    pluginId: 'agentTraces',
    name: i18n.translate('agentTraces.topNav.refreshResultsShortcut', {
