...
export const QueryExecutionButton: React.FC<QueryExecutionButtonProps> = ({
  ...
  const buttonText = needsUpdate
    ? i18n.translate('agentTraces.topNav.queryExecutionButton.update', {
        defaultMessage: 'Update',
      })
    : i18n.translate('agentTraces.topNav.queryExecutionButton.refresh', {
  ...
  const cancelButton = shouldShowCancelButton ? (
    <EuiButtonIcon
      ...
      color="danger"
      onClick={onCancel}
      data-test-subj="agentTracesQueryCancelButton"
      aria-label={i18n.translate('agentTraces.topNav.queryExecutionButton.cancelAriaLabel', {
