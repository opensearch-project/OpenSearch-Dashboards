...
export function DiscoverSidebar(props: DiscoverSidebarProps) {
  ...
  return (
    <I18nProvider>
      <EuiSplitPanel.Outer
        className="agentTraces_fieldSelector_list eui-yScroll"
        aria-label={i18n.translate(
          'agentTraces.discover.fieldChooser.filter.indexAndFieldsSectionAriaLabel',
          {
      ...
      >
        <EuiSplitPanel.Inner
          grow={false}
          paddingSize="none"
          className="agentTracesSideBar_headerContainer"
        >
        ...
        <EuiSplitPanel.Inner
          grow={false}
          paddingSize="none"
          className="agentTracesSideBar_searchContainer"
        >
          <DiscoverFieldSearch
        ...
        <EuiSplitPanel.Inner
          className="eui-yScroll agentTracesSideBar_fieldListContainer"
          paddingSize="none"
        >
            ...
            <>
              ...
              {queryFields.length > 0 && (
                <FieldList
                  ...
                  shortDotsEnabled={shortDotsEnabled}
                  title={i18n.translate(
                    'agentTraces.discover.fieldChooser.filter.queryFieldsTitle',
                    {
              ...
              <FieldList
                ...
                shortDotsEnabled={shortDotsEnabled}
                title={i18n.translate(
                  'agentTraces.discover.fieldChooser.filter.discoveredFieldsTitle',
                  {
