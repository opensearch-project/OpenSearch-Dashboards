...
describe('FacetValue', () => {
  ...
  it('shows tooltip with bucket display value', () => {
    ...
    expect(valueSpan).toHaveClass('agentTracesSidebarField__name');
  });
  ...
  it('renders bucket count', () => {
    ...
    expect(countElement).toHaveClass('agentTracesSidebarFacetValue__count');
  });

  it('has correct CSS classes', () => {
    render(<FacetValue {...mockProps} />);

    const container = screen.getByTestId('agentTracesSidebarFacetValue');
    expect(container).toHaveClass('agentTracesSidebarFacetValue');

    const actionButtons = container.querySelector('.agentTracesSidebarField__actionButtons');
    expect(actionButtons).toBeInTheDocument();

    const countElement = container.querySelector('.agentTracesSidebarFacetValue__count');
    expect(countElement).toBeInTheDocument();

    const actionButton = container.querySelector('.agentTracesSidebarField__actionButton');
