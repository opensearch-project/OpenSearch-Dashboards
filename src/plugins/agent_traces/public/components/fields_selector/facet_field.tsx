  ...
  return (
    <EuiPanel hasBorder={false} hasShadow={false} color="transparent" paddingSize="none">
      <EuiButtonEmpty
        ...
        size="xs"
        className="agentTracesSideBar__facetField"
        data-test-subj="agentTracesSideBarFacetFieldButton"
      ...
      >
        <EuiFlexGroup
          ...
          alignItems="center"
          responsive={false}
          data-test-subj="agentTracesSidebarField"
        >
        ...
        buckets.map((bucket: Bucket, index) => {
          return (
            <EuiPanel
              ...
              hasShadow={false}
              color="transparent"
              className="agentTracesSideBar__facetValue"
