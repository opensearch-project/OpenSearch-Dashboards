...
export const DiscoverField = ({
  ...
  return (
    <EuiFlexGroup
      ...
      alignItems="center"
      responsive={false}
      className="agentTracesSidebarField"
        ...
        <div className="agentTracesSidebarField__actionButtons">
          {showSummary && (
            <EuiPopover
              ...
              button={
                <EuiToolTip
                  ...
                  content={i18n.translate(
                    'agentTraces.discover.fieldChooser.discoverField.detailsTooltip',
                    {
              ...
              panelClassName="agentTracesSidebarItem__fieldPopoverPanel"
            >
              <EuiPopoverTitle tabIndex={0}>
                {i18n.translate(
                  'agentTraces.discover.fieldChooser.discoverField.fieldTopValuesLabel',
                  {
