    ...
    <EuiFlexGroup responsive={false} gutterSize="xs">
      <EuiFlexItem grow={false}>
        <EuiButtonEmpty
          ...
          size="xs"
          className="agentTracesSideBar_normalizeIndexPattern"
          data-test-subj="dscSideBarNormalizeIndexPatternButton"
        >
          {i18n.translate('agentTraces.discover.fieldChooser.dataFrame.normalizeIndexPattern', {
      ...
      <EuiFlexItem grow={false}>
        <EuiButtonEmpty
          ...
          size="xs"
          className="agentTracesSideBar_createIndexPattern"
          data-test-subj="dscSideBarCreateIndexPatternButton"
        >
          {i18n.translate('agentTraces.discover.fieldChooser.dataFrame.createIndexPattern', {
