...
export function DiscoverFieldBucket({ field, bucket, onAddFilter }: Props) {
  const emptyTxt = i18n.translate('agentTraces.discover.fieldChooser.detailViews.emptyStringText', {
    defaultMessage: 'Empty string',
  });
  const addText = i18n.translate(
    'agentTraces.discover.fieldChooser.detailViews.filterValueButton',
    {
      defaultMessage: 'Filter for value',
    }
  );
  const addLabel = i18n.translate(
    'agentTraces.discover.fieldChooser.detailViews.filterValueButtonAriaLabel',
    {
  ...
  const removeText = i18n.translate(
    'agentTraces.discover.fieldChooser.detailViews.filterOutValueButton',
    {
      defaultMessage: 'Filter out value',
    }
  );
  const removeLabel = i18n.translate(
    'agentTraces.discover.fieldChooser.detailViews.filterOutValueButtonAriaLabel',
    {
