...
describe('FacetField', () => {
  ...
  it('renders field name and icon', () => {
    ...
    expect(screen.getByTestId('agentTracesSideBarFacetFieldButton')).toBeInTheDocument();
  });
  ...
  it('toggles expansion when button is clicked', () => {
    ...
    const toggleButton = screen.getByTestId('agentTracesSideBarFacetFieldButton');
