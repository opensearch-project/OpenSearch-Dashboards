...
describe('FacetList', () => {
  ...
  it('renders facet list with title', () => {
    ...
    expect(screen.getByTestId('agentTracesSideBarFieldGroupButton')).toBeInTheDocument();
  });
  ...
  it('toggles expansion when button is clicked', () => {
    ...
    const toggleButton = screen.getByTestId('agentTracesSideBarFieldGroupButton');
