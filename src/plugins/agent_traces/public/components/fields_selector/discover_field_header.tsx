...
export function DiscoverFieldHeader({ onCollapse }: IDiscoverFieldHeaderProps) {
  const fieldsHeaderText = i18n.translate('agentTraces.discover.fieldChooser.Header', {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    name: i18n.translate('agentTraces.discoverFieldHeader.toggleFieldsPanelShortcut', {
      defaultMessage: 'Toggle fields panel',
    }),
    category: i18n.translate('agentTraces.discoverFieldHeader.panelLayoutCategory', {
  ...
  return (
    <EuiFlexGroup responsive={false} gutterSize="xs">
      <EuiFlexItem>
        <EuiText size="s" className="agentTracesSidebar__headerTitle__text">
          {fieldsHeaderText}
        </EuiText>
      </EuiFlexItem>
