...
const errorDefaultTitle = i18n.translate('agentTraces.errorPanel.defaultTitle', {
  defaultMessage: 'An error occurred while executing the query',
});
const detailsText = i18n.translate('agentTraces.errorPanel.details', {
  defaultMessage: 'Details',
});
const typeText = i18n.translate('agentTraces.errorPanel.type', {
  defaultMessage: 'Type',
});
...
export const ErrorGuard = ({ registryTab, children }: ErrorGuardProps): JSX.Element | null => {
  ...
  return (
    <EuiErrorBoundary>
      <EuiFlexGroup direction="column" alignItems="center" className="agentTracesErrorGuard">
        <EuiIcon type="alert" size="xl" color="red" />
        <EuiTitle size="l">
          <h1>{error.message.reason || errorDefaultTitle}</h1>
        </EuiTitle>
        <div className="agentTracesErrorGuard__errorsSection">
