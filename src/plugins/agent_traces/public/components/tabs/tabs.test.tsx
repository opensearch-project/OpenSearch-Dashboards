...
describe('AgentTracesTabsComponent', () => {
  const mockServices = {
    tabRegistry: {
      getAllTabs: jest.fn(() => [
        {
      ...
      getTab: jest.fn((id: string) => ({
        ...
        prepareQuery: jest.fn((query: any) => 'cache-key-' + query.query),
        flavor: [AgentTracesFlavor.Traces],
      })),
    },
  };
  ...
  it('should return null when flavorId is null', () => {
    ...
    mockUseFlavorId.mockReturnValue(AgentTracesFlavor.Traces); // Reset for other tests
  });
