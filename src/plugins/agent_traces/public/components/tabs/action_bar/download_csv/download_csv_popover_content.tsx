  ...
  const downloadOptions = useMemo(() => {
    const options = [
      {
        ...
        label: (
          <FormattedMessage
            id="agentTraces.discover.downloadCsvOptionVisible"
    ...
    if (showMaxOption) {
      options.push({
        ...
        label: (
          <FormattedMessage
            id="agentTraces.discover.downloadCsvOptionMax"
    ...
    <div className="dscDownloadCsvPopoverContent" data-test-subj="dscDownloadCsvPopoverContent">
      <div className="dscDownloadCsvPopoverContent__titleWrapper">
        <EuiText data-test-subj="dscDownloadCsvTitle" size="m">
          <strong>
            <FormattedMessage
              id="agentTraces.discover.downloadCsvTitle"
      ...
      <div className="dscDownloadCsvPopoverContent__form">
        ...
        >
          <FormattedMessage
            id="agentTraces.discover.downloadCsvSubmit"
