...
export const DiscoverDownloadCsv = ({ indexPattern, hits, rows }: DiscoverDownloadCsvProps) => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    name: i18n.translate('agentTraces.downloadCsv.downloadCsvShortcut', {
      defaultMessage: 'Download CSV',
    }),
    category: i18n.translate('agentTraces.downloadCsv.dataActionsCategory', {
  ...
  return (
    <EuiPopover
      button={
        ...
        >
          <FormattedMessage
            id="agentTraces.discover.downloadCsvButtonText"
