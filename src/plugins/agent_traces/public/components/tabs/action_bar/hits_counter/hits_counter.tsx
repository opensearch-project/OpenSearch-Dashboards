      ...
      >
        <EuiFlexItem grow={false}>
          <EuiText size="s">
            {hits ? (
              <FormattedMessage
                id="agentTraces.discover.hitsResultTitle"
              ...
              <FormattedMessage
                id="agentTraces.discover.noHitsResultTitle"
        ...
        {showResetButton && (
          <EuiFlexItem grow={false}>
            <EuiButtonEmpty
              ...
              size="s"
              aria-label={i18n.translate('agentTraces.discover.reloadSavedSearchButton', {
                defaultMessage: 'Reset search',
              })}
            >
              <FormattedMessage
                id="agentTraces.discover.reloadSavedSearchButton"
                defaultMessage="Reset search"
              />
            </EuiButtonEmpty>
          </EuiFlexItem>
