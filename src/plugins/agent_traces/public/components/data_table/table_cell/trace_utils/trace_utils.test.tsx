...
describe('trace_utils', () => {
  ...
  describe('isOnTracesPage', () => {
    it('should return true when pathname includes /agentTraces/traces', () => {
    ...
    it('should return true when pathname includes /agentTraces with hash routing', () => {
      window.history.pushState(
        {},
        '',
        '/w/workspace/app/agentTraces/#/?_q=...&_a=(ui:(activeTabId:traces))'
      );
      expect(isOnTracesPage()).toBe(true);
    });
    ...
    it('should return false when neither pathname nor hash include /agentTraces/traces', () => {
    ...
    it('should handle partial matches correctly', () => {
      window.history.pushState({}, '', '/app/agentTrace'); // missing 's' - not /agentTraces
      expect(isOnTracesPage()).toBe(false);
    });
  });
  ...
  describe('buildTraceDetailsUrl', () => {
    ...
    it('should build URL with span ID and trace ID', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN'),spanId:'span-123',traceId:'trace-456')"
      );
    });
    ...
    it('should build URL with only span ID when trace ID is empty', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN'),spanId:'span-123')"
      );
    });
    ...
    it('should use default values when dataset is null', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'default-dataset-id',title:'otel-v1-apm-span-*',type:'INDEX_PATTERN'),spanId:'span-123',traceId:'trace-456')"
      );
    });
    ...
    it('should handle base path correctly', () => {
      window.history.pushState({}, '', '/custom-base/app/agentTraces/traces');
      const dataset = {
        id: 'test-dataset',
        title: 'test-title',
        type: 'INDEX_PATTERN',
      ...
      expect(result).toBe(
        "http://localhost:5601/custom-base/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN'),spanId:'span-123',traceId:'trace-456')"
      );
    });
    ...
    it('should handle special characters in dataset values', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset-with-special-chars',title:'test title with spaces',type:'INDEX_PATTERN'),spanId:'span-123',traceId:'trace-456')"
      );
    });
    ...
    it('should handle empty span ID', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN'),spanId:'',traceId:'trace-456')"
      );
    });
    ...
    it('should include timeFieldName when present', () => {
      ...
      expect(result).toBe(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN',timeFieldName:'endTime'),spanId:'span-123',traceId:'trace-456')"
      );
    });
  ...
  describe('handleSpanIdNavigation', () => {
    ...
    it('should handle null row data', () => {
      ...
      expect(mockOpen).toHaveBeenCalledWith(
        "http://localhost:5601/app/agentTraces/traces/traceDetails#/?_a=(dataset:(id:'test-dataset',title:'test-title',type:'INDEX_PATTERN'),spanId:'')",
        '_blank'
      );
    });
