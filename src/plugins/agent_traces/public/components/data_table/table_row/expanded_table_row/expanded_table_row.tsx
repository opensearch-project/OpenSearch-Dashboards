...
export const ExpandedTableRow: React.FC<ExpandedTableRowProps> = ({
  ...
  const defaultHeader = i18n.translate('agentTraces.dataTable.expandedRow.documentHeading', {
    defaultMessage: 'Expanded document',
  });
  return (
    <tr key={'x' + row._id}>
      <td
        className="agentTracesDocTable__detailsParent"
      ...
      >
        <EuiFlexGroup gutterSize="m" alignItems="center">
          <EuiFlexItem
            grow={false}
            className="agentTracesDocTable__detailsIconContainer"
