      ...
      <EuiPopover
        button={
          <EuiButtonEmpty
            ...
            size="xs"
          >
            <div className="agentTracesQueryPanelActions__buttonTextWrapper">
              <EuiText size="xs">
                {i18n.translate('agentTraces.queryPanel.actions.actions', {
        ...
        <EuiListGroup>
          {registry.getSortedActions().map((action) => {
            ...
            return (
              <EuiButtonEmpty
                key={action.id}
                className="agentTracesQueryPanelActions__item"
