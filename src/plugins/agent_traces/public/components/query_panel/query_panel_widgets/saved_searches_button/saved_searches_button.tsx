...
const label = i18n.translate('agentTraces.queryPanel.savedSearchesLabel', {
    ...
    <EuiPopover
      button={
        <EuiButtonEmpty
          ...
          size="xs"
        >
          <div className="agentTracesSavedSearchesButton__buttonTextWrapper">
      ...
      panelClassName="agentTracesSavedSearchesButton__popoverContent"
    >
      <EuiListGroup className="agentTracesSavedSearchesButton__optionList">
        <div className="agentTracesSavedSearchesButton__option">
          <EuiButtonEmpty
            className="agentTracesSavedSearchesButton__optionButton"
            data-test-subj="savedSearchesSaveButton"
            iconType="save"
            // Nothing to save into yet (TopNav not mounted, or still loading). Disabled rather than
            // hidden so the popover doesn't change shape under the cursor.
            disabled={!saveSearchAction}
            onClick={handleSave}
          >
            <EuiText size="xs">
              {i18n.translate('agentTraces.queryPanel.savedSearches.saveSearch', {
        ...
        <div className="agentTracesSavedSearchesButton__option">
          ...
          >
            <EuiText size="xs">
              {i18n.translate('agentTraces.queryPanel.savedSearches.browseSearches', {
