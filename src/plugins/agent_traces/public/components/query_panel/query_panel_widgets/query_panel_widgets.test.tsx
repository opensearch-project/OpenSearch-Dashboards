...
describe('QueryPanelWidgets', () => {
  ...
  describe('component rendering', () => {
    it('renders all basic components with correct layout', () => {
      ...
      expect(container.querySelector('.agentTracesQueryPanelWidgets')).toBeInTheDocument();
      ...
      const separators = container.querySelectorAll(
        '.agentTracesQueryPanelWidgets__verticalSeparator'
      );
  ...
  describe('layout structure', () => {
    it('maintains correct component order in left section', () => {
      ...
      const leftSection = container.querySelector('.agentTracesQueryPanelWidgets__left');
    ...
    it('maintains correct component order in right section', () => {
      ...
      const rightSection = container.querySelector('.agentTracesQueryPanelWidgets__right');
