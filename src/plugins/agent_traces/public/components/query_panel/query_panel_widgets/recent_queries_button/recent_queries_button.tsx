...
const label = i18n.translate('agentTraces.queryPanel.recentQueryLabel', {
...
export const RecentQueriesButton = () => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    name: i18n.translate('agentTraces.keyboardShortcut.recentQueries.name', {
      defaultMessage: 'Recent queries',
    }),
    ...
    <EuiPopover
      ...
      button={
        <EuiButtonEmpty
          ...
          data-test-subj="agentTracesRecentQueriesButton"
          size="xs"
        >
          <div className="agentTracesRecentQueriesButton__buttonTextWrapper">
      ...
      panelClassName="agentTracesRecentQueriesButton__popover"
    >
      <RecentQueriesTable
        isVisible={popoverIsOpen}
        queryString={services.data.query.queryString}
        onClickRecentQuery={onClick}
        className="agentTracesRecentQueriesButton__table"
      />
    </EuiPopover>
  );
};
