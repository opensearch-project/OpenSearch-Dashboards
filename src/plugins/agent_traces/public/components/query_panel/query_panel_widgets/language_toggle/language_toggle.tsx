...
const promptOptionText = i18n.translate(
  'agentTraces.queryPanelFooter.languageToggle.promptOption',
  {
    defaultMessage: 'AI',
  }
);
...
export const LanguageToggle = () => {
  ...
  return (
    ...
    <div className="agentTracesLanguageToggle">
      <EuiPopover
        button={
          <EuiBetaBadge
            onClick={onButtonClick}
            data-test-subj="queryPanelFooterLanguageToggle"
            className={classNames('agentTracesLanguageToggle__button', {
              ['agentTracesLanguageToggle__button--aiMode']: isPromptMode,
            })}
            label={badgeLabel}
          />
        }
