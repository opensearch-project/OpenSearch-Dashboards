...
const QueryPanel = () => {
  ...
  return (
    <EuiPanel paddingSize="s" borderRadius="none" className="agentTracesQueryPanel">
      <QueryPanelWidgets />
      <div className="agentTracesQueryPanel__editorsWrapper">
        <QueryPanelEditor />
      ...
      {isLoading && (
        <EuiProgress
          ...
          color="accent"
          position="absolute"
          data-test-subj="agentTracesQueryPanelIsLoading"
        />
      )}
    </EuiPanel>
  );
