...
export const useQueryPanelEditor = (): UseQueryPanelEditorReturnType => {
  ...
  keyboardShortcut?.useKeyboardShortcut({
    ...
    name: i18n.translate('agentTraces.queryPanelEditor.focusQueryBarShortcut', {
      defaultMessage: 'Focus query bar',
    }),
    category: i18n.translate('agentTraces.queryPanelEditor.searchCategory', {
  ...
  const provideCompletionItems = useCallback(
    async (
      ...
      try {
        // Get the effective language for autocomplete (PPL -> PPL_Simplified for agent traces app)
        ...
        const suggestions = await services?.data?.autocomplete?.getQuerySuggestions({
          ...
          services: services as any, // AgentTracesServices storage type incompatible with IDataPluginServices.DataStorage
        });
  ...
  const placeholder = useMemo(() => {
    const enabledPromptPlaceholder = i18n.translate(
      'agentTraces.queryPanel.queryPanelEditor.enabledPromptPlaceholder',
      {
    ...
    const disabledPromptPlaceholder = i18n.translate(
      'agentTraces.queryPanel.queryPanelEditor.disabledPromptPlaceholder',
      {
    ...
    const promptModePlaceholder = i18n.translate(
      'agentTraces.queryPanel.queryPanelEditor.promptPlaceholder',
      {
