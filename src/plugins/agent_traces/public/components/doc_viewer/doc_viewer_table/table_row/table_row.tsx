  ...
  return (
    <tr key={field} data-test-subj={`tableDocViewRow-${field}`}>
      {typeof onFilter === 'function' && (
        <td className="agentTracesDocViewer__buttons" data-test-subj="osdDocViewerButtons">
      ...
      <td className="agentTracesDocViewer__field" data-test-subj="osdDocViewerField">
        <FieldName
          fieldName={field}
          fieldType={fieldType}
