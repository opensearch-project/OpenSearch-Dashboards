...
export const DiscoverNoResults = ({ queryString, query, savedQuery, timeFieldName }: Props) => {
    ...
    return [
      ...(sampleQueries.length > 0
        ? [
            {
              id: 'sample_queries',
              name: i18n.translate('agentTraces.discover.emptyPrompt.sampleQueries.title', {
      ...
      ...(savedQueries.length > 0
        ? [
            {
              id: 'saved_queries',
              name: i18n.translate('agentTraces.discover.emptyPrompt.savedQueries.title', {
  ...
  return (
    <I18nProvider>
      <>
        <EuiEmptyPrompt
          className="agentTracesNoResults"
          ...
          title={
            <EuiText size="s">
              <h2>
                {i18n.translate('agentTraces.discover.emptyPrompt.title', {
          ...
          body={
            <EuiText size="s" data-test-subj="discoverNoResultsTimefilter">
              <p>
                {i18n.translate('agentTraces.discover.emptyPrompt.body', {
                  defaultMessage:
