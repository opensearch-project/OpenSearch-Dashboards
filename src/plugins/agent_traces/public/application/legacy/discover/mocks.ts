...
export type Setup = jest.Mocked<AgentTracesPluginSetup>;
export type Start = jest.Mocked<AgentTracesPluginStart>;
...
const createAgentTracesServicesMock = (): AgentTracesServices =>
  buildServices(
    ...
    {} as any // Mock queryPanelActionsRegistry
  );

export const discoverPluginMock = {
  createAgentTracesServicesMock,
  createSetupContract,
  createStartContract,
};
