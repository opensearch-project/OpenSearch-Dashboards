...
import { createMockAgentTracesServices } from '../../__mocks__';
...
describe('resetLegacyStateActionCreator', () => {
  let mockServices: ReturnType<typeof createMockAgentTracesServices>;
  let mockDispatch: jest.MockedFunction<any>;

  beforeEach(() => {
    jest.clearAllMocks();
    mockServices = createMockAgentTracesServices();
