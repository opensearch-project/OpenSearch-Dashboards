...
export const onEditorRunActionCreator = (services: AgentTracesServices, editorText: string) => (
  ...
  if (editorMode === EditorMode.Prompt) {
    ...
    if (!promptModeIsAvailable) {
      services.notifications.toasts.addWarning({
        title: i18n.translate('agentTraces.queryPanel.queryAssist-not-available-title', {
          defaultMessage: 'Unavailable',
        }),
        text: i18n.translate('agentTraces.queryPanel.queryAssist-not-available-text', {
