...
import * as CurrentAgentTracesIdHook from './use_current_agent_traces_id';
...
describe('useInitialQueryExecution', () => {
  ...
  beforeEach(() => {
    ...
    jest.spyOn(CurrentAgentTracesIdHook, 'useCurrentAgentTracesId').mockReturnValue(undefined);
  ...
  describe('when current loading a saved search', () => {
    beforeEach(() => {
      jest.spyOn(CurrentAgentTracesIdHook, 'useCurrentAgentTracesId').mockReturnValue('mock-id');
    });
