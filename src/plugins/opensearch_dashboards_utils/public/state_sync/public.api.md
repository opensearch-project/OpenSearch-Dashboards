...
// @public
export const createOsdUrlStateStorage: ({ useHash, history, onGetError, onSetError, }?: {
    useHash: boolean;
...
// Warning: (ae-unresolved-link) The @link reference could not be resolved: The package "opensearch-dashboards" does not have an export "stateSync"
// Warning: (ae-unresolved-link) The @link reference could not be resolved: The package "opensearch-dashboards" does not have an export "BaseState"
//
// @public
