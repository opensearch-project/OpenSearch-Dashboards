 ...
 * 1. WORKSPACE_ID_CONSUMER should be placed before the other two wrappers as it cost little
 ...
 */
export const PRIORITY_FOR_WORKSPACE_ID_CONSUMER_WRAPPER = 0;
export const PRIORITY_FOR_PERMISSION_CONTROL_WRAPPER = -1;
export const PRIORITY_FOR_WORKSPACE_CONFLICT_CONTROL_WRAPPER = -2;
