              ...
              <EuiPanel>
                ...
                <EuiText size="xs">
                  {i18n.translate('workspace.creator.form.associateDataSourceDescription', {
                    defaultMessage:
                      'Optionally add one or more data sources to make them available in the workspace. If a selected data source has related Direct Query data sources, they will also be available in the workspace.',
                  })}
                </EuiText>
                <SelectDataSourcePanel
