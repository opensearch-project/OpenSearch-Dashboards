...
import { CreateDrilldownAction } from './create_drilldown_action';
  ...
  const input = getSampleDashboardInput({
    panels: {
      '123': getSampleDashboardPanel<ContactCardEmbeddableInput>({
        explicitInput: { firstName: 'Thanh', id: '123' },
...
test('Executes the create drilldown action', async () => {
  let SavedObjectFinder: any;
  let notifications: any;
  const action = new CreateDrilldownAction(
    coreStart,
    SavedObjectFinder,
    notifications,
