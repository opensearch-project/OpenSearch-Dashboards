...
export const DashboardListing = (props: DashboardListingProps) => 
      <I18nProvider>
        <TableListView
          ...
          createItem={props.hideWriteControls ? undefined : props.createItem}
          findItems={props.findItems}
          deleteItems={props.hideWriteControls ? undefined : props.deleteItems}
          editItem={props.hideWriteControls ? undefined : props.editItem}
          tableColumns={getTableColumns(props)}
          listingLimit={props.listingLimit}
          initialFilter={props.initialFilter ?? EMPTY_FILTER}
          initialPageSize={props.initialPageSize}
          noItemsFragment={getNoItemsMessage(props)}
...
const getNoItemsMessage = ({core, createItem, hideWriteControls}: DashboardListingProps) => {
...
const getTableColumns = ({getViewUrl} : DashboardListingProps) => {
  const tableColumns = [
    {
      field: 'title',
