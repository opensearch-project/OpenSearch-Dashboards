...
export const EXECUTE_QUERY_TOOL_DEFINITION = {
  ...
  description: `Updates the query bar with a DQL/PPL/Lucene/SQL query and runs the search in the classic Discover UI. A single call can set the query, the query language, and the time range (from/to) together.
