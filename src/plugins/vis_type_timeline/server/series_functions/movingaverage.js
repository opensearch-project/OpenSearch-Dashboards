...
export default new Chainable('movingaverage', {
  args: [
    ...
    },
    {
      name: 'window',
      types: ['number', 'string'],
      help: i18n.translate('timeline.help.functions.movingaverage.args.windowHelpText', {
        defaultMessage:
    ...
    },
    {
      name: 'position',
      types: ['string', 'null'],
      help: i18n.translate('timeline.help.functions.movingaverage.args.positionHelpText', {
        defaultMessage:
  ...
  aliases: ['mvavg'],
  help: i18n.translate('timeline.help.functions.movingaverageHelpText', {
    defaultMessage:
  ...
  fn: function movingaverageFn(args, tlConfig) {
    return alter(args, function (eachSeries, _window, _position) {
      ...
      if (!_.includes(validPositions, _position)) {
        throw new Error(
          i18n.translate(
            'timeline.serverSideErrors.movingaverageFunction.notValidPositionErrorMessage',
            {
