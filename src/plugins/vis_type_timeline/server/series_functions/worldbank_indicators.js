...
export default new Datasource('worldbank_indicators', {
  args: [
    {
      ...
      types: ['string', 'null'],
      help: i18n.translate('timeline.help.functions.worldbankIndicators.args.countryHelpText', {
    ...
    },
    {
      name: 'indicator',
      types: ['string', 'null'],
      help: i18n.translate('timeline.help.functions.worldbankIndicators.args.indicatorHelpText', {
        defaultMessage:
  ...
  aliases: ['wbi'],
  help: i18n.translate('timeline.help.functions.worldbankIndicatorsHelpText', {
    defaultMessage: `
    [experimental]
  ...
  fn: function worldbankIndicators(args, tlConfig) {
    ...
    return Promise.all(seriesLists.map(({ list }) => list[0])).then(function (list) {
      return {
        type: 'seriesList',
        list: list,
      };
