...
import { SUGGESTION_TYPE, suggest } from './timeline_expression_input_helpers';
...
import { ITimelineFunction } from '../../common/types';

describe('Timeline expression suggestions', () => {
