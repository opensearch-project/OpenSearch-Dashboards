...
import { Series, Sheet } from '../helpers/timeline_request_handler';
...
interface TimelineVisComponentProps {
...
export { TimelineVisComponent as default };
