...
function getArgumentsHelp(
  functionHelp: ITimelineFunction | undefined,
...
async function extractSuggestionsFromParsedResult(
  ...
  functionList: ITimelineFunction[],
...
export function getSuggestion(
  suggestion: ITimelineFunction | TimelineFunctionArgs,
  ...
  switch (type) {
    case SUGGESTION_TYPE.ARGUMENTS:
      ...
      detail = `${i18n.translate(
        'timeline.expressionSuggestions.argument.description.acceptsText',
        {
          defaultMessage: 'Accepts',
        }
      )}: ${(suggestion as TimelineFunctionArgs).types}`;
    ...
    case SUGGESTION_TYPE.FUNCTIONS:
      ...
      detail = `(${
        (suggestion as ITimelineFunction).chainable
          ? i18n.translate('timeline.expressionSuggestions.func.description.chainableHelpText', {
              defaultMessage: 'Chainable',
            })
          : i18n.translate('timeline.expressionSuggestions.func.description.dataSourceHelpText', {
