...
import { getAWSCredential, getCredential, getDataSource } from './configure_client_utils';
...
const getQueryClient = async (
  ...
  let rootClient = clientPool.getClientFromPool(cacheKey, type, request) as Client;
