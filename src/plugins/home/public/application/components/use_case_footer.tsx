...
export const UseCaseFooter = ({
  ...
  // const navGroupsMapRef = useRef<Observable<NavGroupItemInMap | undefined>>(getCurrentNavGroup$());
  ...
  // const appId = navGroupsMap![useCaseId]?.navLinks[0].id;

  const appId = 'workspace_overview';
