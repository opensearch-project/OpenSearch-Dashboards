...
export class OsdMcpServerPlugin implements Plugin<OsdMcpServerPluginSetup, OsdMcpServerPluginStart> {
  public setup(core: CoreSetup): OsdMcpServerPluginSetup {
    ...
    console.log('🔍 OSD MCP SERVER PLUGIN: Checking if reduxBridgeClient is available on window...');
    console.log('🔍 OSD MCP SERVER PLUGIN: window.reduxBridgeClient =', (window as any).reduxBridgeClient);
  ...
  public start(core: CoreStart): OsdMcpServerPluginStart {
    ...
    console.log('🔍 OSD MCP SERVER PLUGIN: Final check - window.reduxBridgeClient =', (window as any).reduxBridgeClient);
    return {};
  }
