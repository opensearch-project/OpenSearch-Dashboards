 ...
 *
 * TODO: Update link
 * {@link https://github.com/opensearch-project/OpenSearch-Dashboards/blob/master/src/plugins/opensearch-dashboards-utils/docs/state-sync/storages/osd_url_storage.md | Refer to this guide for more info}
 * @public
 */
...
/**
 * Creates {@link IOsdUrlStateStorage} state storage
 * @returns - {@link IOsdUrlStateStorage}
 * @public
 */
export const createOsdUrlStateStorage = (
  {
    useHash = false,
    history,
    onGetError,
  ...
  return {
    ...
    change$: <State>(key: string) =>
      new Observable((observer) => {
        ...
        map(() => getStateFromOsdUrl<State>(key)),
        catchError((error) => {
