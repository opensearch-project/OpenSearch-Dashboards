 ...
 *
 * Go {@link https://github.com/opensearch-project/OpenSearch-Dashboards/tree/master/src/plugins/opensearch-dashboards-utils/docs/state_sync | here} for a complete guide and examples.
 *
 * @example
 *
