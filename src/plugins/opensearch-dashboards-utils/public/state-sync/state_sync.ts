 ...
 *
 * Go {@link https://github.com/opensearch-project/OpenSearch-Dashboards/tree/master/src/plugins/opensearch-dashboards-utils/docs/state-sync | here} for a complete guide and examples.
 *
 * @example
 *
 ...
 * ```ts
 * const stateStorage = createOsdUrlStateStorage({useHash: config.get('state:stateContainerInSessionStorage')})
 * syncState({
 *   storageKey: '_s',
 *   stateContainer,
 *   stateStorage
