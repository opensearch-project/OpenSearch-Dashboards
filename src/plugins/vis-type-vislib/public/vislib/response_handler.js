...
function handlerFunction(convertTable) {
  return function (response, dimensions) {
    ...
    if (!converted) {
      ...
      // https://github.com/opensearch-project/OpenSearch-Dashboards/blob/7bfb68cd24ed42b1b257682f93c50cd8d73e2520/src/opensearch-dashboards/components/vislib/components/zero-injection/inject_zeros.js#L32
      converted = { rows: [] };
    }
