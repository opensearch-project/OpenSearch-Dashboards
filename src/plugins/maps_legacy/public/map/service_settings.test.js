...
describe('service_settings (FKA tile_map test)', function () {
  ...
  describe('File layers', function () {
    ...
    it('should load manifest (individual props)', async () => {
      const expected = {
        attribution:
          '<a rel="noreferrer noopener" href="http://www.naturalearthdata.com/about/terms-of-use">Made with NaturalEarth</a> | <a rel="noreferrer noopener" href="https://www.opensearch.co/elastic-maps-service">OpenSearch Maps Service</a>',
        format: 'geojson',
        fields: [
