...
import { OpenSearchQueryConfig } from './build_opensearch_query';
import { GetConfigFn, UI_SETTINGS } from '../..';

interface OpenSearchDashboardsConfig {
  get: GetConfigFn;
}

export function getOpenSearchQueryConfig(config: OpenSearchDashboardsConfig) {
