...
import { IDatasetFieldList, DatasetField, datasetFieldList as fieldList } from '../fields';
import {
  DatasetFieldMap,
  DatasetSpec,
  DatasetSavedObjectReference as SavedObjectReference,
  DatasetSourceFilter as SourceFilter,
  DatasetTypeMeta as TypeMeta,
} from '../types';
...
export class Dataset implements IDataset {
  ...
  public fields: IDatasetFieldList & { toSpec: () => DatasetFieldMap };
  ...
  constructor({ spec = {}, fieldFormats, shortDotsEnable = false, metaFields = [] }: DatasetDeps) {
    // set dependencies
   ...
   */
  private fieldSpecsToFieldFormatMap = (fldList: DatasetSpec['fields'] = {}) =>
  ...
  getComputedFields() {
    ...
    // dataset.flattenHit will override "_source" values when the same field is also defined in "fields"
  ...
  getFieldByName(name: string): DatasetField | undefined {
