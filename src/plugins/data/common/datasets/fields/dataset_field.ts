...
import { DatasetFieldSpec, Dataset } from '../..';

export class DatasetField implements IDatasetFieldType {
  readonly spec: DatasetFieldSpec;
  readonly displayName: string;
  private readonly osdFieldType: OsdFieldType;

  constructor(spec: DatasetFieldSpec, displayName: string) {
