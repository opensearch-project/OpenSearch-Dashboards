...
import { getOpenSearchPreference } from './get_opensearch_preference';
...
describe('Get OpenSearch preference', () => {
  ...
  test('returns the session ID if set to sessionId', () => {
    ...
    const preference = getOpenSearchPreference(mockCoreStart.uiSettings, 'my_session_id');
  ...
  test('returns the custom preference if set to custom', () => {
    ...
    const preference = getOpenSearchPreference(mockCoreStart.uiSettings);
