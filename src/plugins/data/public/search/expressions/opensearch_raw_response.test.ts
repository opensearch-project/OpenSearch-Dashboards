...
import { OpenSearchRawResponse, opensearchRawResponse } from './opensearch_raw_response';
...
describe('opensearchRawResponse', () => {
  describe('converts aggregations to table', () => {
    test('simple aggregation response', () => {
      ...
      const result = opensearchRawResponse.to!.datatable(response, {});
