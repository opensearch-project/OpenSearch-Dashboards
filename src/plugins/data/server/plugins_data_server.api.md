## API Report File for "opensearchDashboards"

> Do not edit this file. It is a report generated by [API Extractor](https://api-extractor.com/).

```ts

import { APICaller as APICaller_2 } from 'opensearch-dashboards/server';
...
import { IContextProvider as IContextProvider_2 } from 'opensearch-dashboards/server';
...
import { OpenSearchDashboardsConfigType as OpenSearchDashboardsConfigType_2 } from 'src/core/server/opensearch_dashboards_config';
import { Logger as Logger_2 } from 'src/core/server/logging';
import { Logger as Logger_3 } from 'opensearch-dashboards/server';
...
import { RecursiveReadonly } from 'opensearch-dashboards/public';
...
//
// @public
export const castOpenSearchToOsdFieldTypeName: (opensearchType: string) => OSD_FIELD_TYPES;
...
export interface IRequestTypesMap {
    ...
    //
    // (undocumented)
    [key: string]: IOpenSearchDashboardsSearchRequest;
    // Warning: (ae-forgotten-export) The symbol "OPENSEARCH_SEARCH_STRATEGY" needs to be exported by the entry point index.d.ts
    // Warning: (ae-forgotten-export) The symbol "IOpenSearchSearchRequest" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    [OPENSEARCH_SEARCH_STRATEGY]: IOpenSearchSearchRequest;
}
...
export interface IResponseTypesMap {
    ...
    //
    // (undocumented)
    [key: string]: IOpenSearchDashboardsSearchResponse;
    // Warning: (ae-forgotten-export) The symbol "IOpenSearchSearchResponse" needs to be exported by the entry point index.d.ts
    //
    // (undocumented)
    [OPENSEARCH_SEARCH_STRATEGY]: IOpenSearchSearchResponse;
}
...
export class Plugin implements Plugin_2<PluginSetup, PluginStart> {
    ...
    start(core: CoreStart): {
        fieldFormats: {
            fieldFormatServiceFactory: (uiSettings: import("opensearch-dashboards/server").IUiSettingsClient) => Promise<import("../common").FieldFormatsRegistry>;
        };
    };
    // (undocumented)
    stop(): void;
...
//
// @public
export type TStrategyTypes = typeof OPENSEARCH_SEARCH_STRATEGY | string;
...
// src/plugins/data/server/index.ts:69:21 - (ae-forgotten-export) The symbol "getOpenSearchQueryConfig" needs to be exported by the entry point index.d.ts
// src/plugins/data/server/index.ts:69:21 - (ae-forgotten-export) The symbol "buildOpenSearchQuery" needs to be exported by the entry point index.d.ts
