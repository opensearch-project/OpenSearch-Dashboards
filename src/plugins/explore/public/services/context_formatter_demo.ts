...
export function demonstrateContextFormatter(): void {
  ...
  console.log('- Recommended Query: source = opensearch_dashboards_sample_data_flights | stats count()');
}
