...
import { ThresholdRangeValue, AxisRole, AggregationType } from '../types';
...
import { getLabelType } from '../utils/collections';
          ...
          <EuiFlexItem grow={false}>
            ...
            >
              <EuiSplitPanel.Inner paddingSize="s" color="subdued">
                ...
                <EuiSpacer size="s" />
                <EuiFormRow
                  label={i18n.translate('explore.stylePanel.gauge.aggregation.type', {
                    defaultMessage: 'Type',
                  })}
                >
                  <EuiSelect
                    value={styleOptions.aggregationType}
                    onChange={(e) =>
                      updateStyleOption('aggregationType', e.target.value as AggregationType)
                    }
                    options={labelType}
                  />
                </EuiFormRow>
                ...
                <GaugeCustomRange
                  ...
                  onCustomRangesChange={(ranges: ThresholdRangeValue[]) => {
