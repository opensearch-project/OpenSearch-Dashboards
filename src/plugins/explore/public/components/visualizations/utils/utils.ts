...
export const applyEchartsAxisStyling = ({ axisStyle }: { axisStyle?: StandardAxes }): any => {
 ...
 * @param categoryField - Field name for categories (e.g., 'product', 'region')
 * @param valueField - Field name for values (e.g., 'sales', 'count')
 ...
 * ]
 */
export const aggregateDataForECharts = (
  data: Array<Record<string, any>>,
  ...
  return [[categoryField, valueField], ...result];
};
