...
interface TextToDashboardArgs {
  ...
  from?: string;
  to?: string;
  // Shared time field for the top-level from/to. Each vis may override with its own
  // timeFieldName; otherwise it falls back to this one.
  timeFieldName?: string;
}
  ...
  return (
    <EuiPanel paddingSize="s" hasBorder hasShadow={false}>
      ...
      {renderable ? (
        ...
        <EuiCallOut size="s" color="danger" title="Could not generate chart">
