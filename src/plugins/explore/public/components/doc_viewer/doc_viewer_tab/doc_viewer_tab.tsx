...
export interface IDocViewerTabProps {
 ...
 * Error Boundaries.
 */
export class DocViewerTab extends React.Component<IDocViewerTabProps, State> {
  state = {
    hasError: false,
    error: '',
  };
  ...
  shouldComponentUpdate(nextProps: IDocViewerTabProps, nextState: State) {
    return (
