...
import { AxisRole, AxisWithStyle } from '../../../../../components/visualizations/types';
...
export interface TabState {
  ...
  visualizations: {
    ...
    axesMapping: Partial<Record<AxisRole, AxisWithStyle>>;
  };
}
...
const tabSlice = createSlice({
  ...
  reducers: {
    ...
    setAxesMapping: (state, action: PayloadAction<Partial<Record<AxisRole, AxisWithStyle>>>) => {
