...
// Mock the components
jest.mock(
  '../../../../legacy/discover/application/components/no_index_patterns/no_index_patterns',
  () => ({
    DiscoverNoIndexPatterns: () => <div data-test-subj="no-index-patterns">No Index Patterns</div>,
  })
);

jest.mock('../../../../legacy/discover/application/components/uninitialized/uninitialized', () => ({
...
jest.mock(
  '../../../../legacy/discover/application/components/loading_spinner/loading_spinner',
  () => ({
    LoadingSpinner: () => <div data-test-subj="loading-spinner">Loading...</div>,
  })
);

jest.mock('../../../../legacy/discover/application/components/no_results/no_results', () => ({
