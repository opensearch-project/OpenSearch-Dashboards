...
describe('DatasetAccordionList', () => {
  ...
  describe('Basic Rendering', () => {
    ...
    it('renders view in explore buttons for all datasets', () => {
      render(<DatasetAccordionList {...defaultProps} />);
      ...
      expect(screen.getByTestId('dataset-view-in-explore-button-dataset-3')).toBeInTheDocument();
    });

    it('renders view in explore button text', () => {
      render(<DatasetAccordionList {...defaultProps} />);
  ...
  describe('View in Explore Functionality', () => {
    ...
    it('calls onViewInExplore with empty logs array when dataset has no logs', () => {
      render(<DatasetAccordionList {...defaultProps} />);

      const viewButton = screen.getByTestId('dataset-view-in-explore-button-dataset-3');
      fireEvent.click(viewButton);

      expect(mockOnViewInExplore).toHaveBeenCalledWith(mockDatasets[2], []);
    });
