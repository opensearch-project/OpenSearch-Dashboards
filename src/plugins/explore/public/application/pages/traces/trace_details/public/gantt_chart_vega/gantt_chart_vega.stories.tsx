...
VaryingDurations.args = {
  data: createMockSpans(
    ...
    [
      ...
      ['api-gateway', 100, 50, 'auth-service', 'validateToken'], // Very fast
      ['api-gateway', 200, 1200, 'product-service', 'getProductRecommendations'], // Very slow
      ['api-gateway', 300, 400, 'user-service', 'getUserPreferences'], // Medium
      ['api-gateway', 800, 700, 'analytics-service', 'trackUserActivity'], // Medium-slow
    ]
  ),
  colorMap,
  height: 250,
...
DeepNesting.args = {
  ...
  colorMap: {
    ...colorMap,
    'client-app': '#2196F3',
    'order-service': '#FF9800',
    'pricing-service': '#9C27B0',
    'tax-service': '#607D8B',
  },
  height: 500,
  onSpanClick: action('Span clicked'),
...
StressTest.parameters = {
  docs: {
    description: {
      story: 'A stress test example with 50 spans to evaluate performance under heavy load.',
    },
  },
