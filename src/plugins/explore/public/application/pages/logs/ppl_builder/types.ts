...
export interface PPLBuilderState {
  // The leading `source|index = <index>` clause verbatim, carried through the
  // round-trip so Builder -> Code re-emits it unchanged (spacing/quoting/index form).
  // Not surfaced or edited by the builder. Absent for a source-less query, where the
