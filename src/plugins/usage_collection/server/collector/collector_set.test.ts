...
describe('CollectorSet', () => {
  describe('registers a collector set and runs lifecycle events', () => {
    ...
    const mockOpenSearchClient = opensearchServiceMock.createClusterClient().asInternalUser;
    ...
    it('should log debug status of fetching from the collector', async () => {
      ...
      const result = await collectors.bulkFetch(mockCallCluster, mockOpenSearchClient);
