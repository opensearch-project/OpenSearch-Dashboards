...
import {
  ...
  registerOpenSearchDashboardsUsageCollector,
...
interface OpenSearchDashboardsUsageCollectionPluginsDepsSetup {
  usageCollection: UsageCollectionSetup;
}

type SavedObjectsRegisterType = SavedObjectsServiceSetup['registerType'];

export class OpenSearchDashboardsUsageCollectionPlugin implements Plugin {
  ...
  private registerUsageCollectors(
    ...
    registerOpenSearchDashboardsUsageCollector(usageCollection, this.legacyConfig$);
