...
describe('Header', () => {
  it('should render existing data sources list when choose to use data source', () => {
    ...
    component
      .find('[data-test-subj="createDatasetStepDataSourceUseDataSourceRadio"]')
      .simulate('change', {
        target: {
          checked: true,
        },
    ...
    expect(
      component
        .find('[data-test-subj="createDatasetStepDataSourceSelectDataSource"]')
        .first()
        .exists()
    ).toBeTruthy();
  });
  ...
  it('should disable next step before select data source', () => {
    ...
    expect(
      component
        .find('[data-test-subj="createDatasetStepDataSourceNextStepButton"]')
        .prop('isDisabled')
    ).toEqual(true);
  });
  ...
  it('should enable next step when pick default option', () => {
    ...
    component
      .find('[data-test-subj="createDatasetStepDataSourceUseDefaultRadio"]')
      .simulate('change', {
        target: {
          checked: true,
        },
  ...
  it('should filter out incompatible data sources', () => {
    ...
    expect(
      component.find('[data-test-subj="createDatasetStepDataSourceSelectDataSource"]').first()
    ).toEqual({});
  });
});
