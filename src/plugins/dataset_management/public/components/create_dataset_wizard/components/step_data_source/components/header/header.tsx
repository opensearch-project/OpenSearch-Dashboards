...
export const Header: React.FC<HeaderProps> = (props: HeaderProps) => {
  ...
  const fetchDataSources = () => {
    ...
    getDataSources(savedObjects.client)
      ...
      .catch(() => {
        toasts.addDanger(
          i18n.translate('datasetManagement.createDataset.stepDataSource.fetchDataSourceError', {
    ...
    <>
      <div>
        <EuiTitle size="s">
          <h2>
            <FormattedMessage
              id="datasetManagement.createDataset.stepDataSourceHeader"
        ...
        <EuiText>
          <FormattedMessage
            id="datasetManagement.createDataset.stepDataSourceLabel"
        ...
        {!hideLocalCluster && (
          <EuiFlexItem grow={false}>
            <EuiSpacer size="m" />
            <EuiRadio
              data-test-subj="createDatasetStepDataSourceUseDefaultRadio"
              id={'useDefault'}
              label={
                <FormattedMessage
                  id="datasetManagement.createDataset.stepDataSource.useDefaultLabel"
            ...
            <EuiSpacer size="m" />
            <EuiRadio
              data-test-subj="createDatasetStepDataSourceUseDataSourceRadio"
              id={'useDataSource'}
              label={
                <FormattedMessage
                  id="datasetManagement.createDataset.stepDataSource.useDataSourceLabel"
        ...
        {dataSourceChecked && (
          <EuiFlexItem grow={false}>
            <EuiSpacer size="m" />
            <EuiSelectable
              data-test-subj="createDatasetStepDataSourceSelectDataSource"
              aria-label={i18n.translate(
                'datasetManagement.createDataset.stepDataSource.searchlabel',
                {
              ...
              searchProps={{
                ...
                placeholder: i18n.translate(
                  'datasetManagement.createDataset.stepDataSource.searchPlaceHolder',
                  {
                    defaultMessage: 'Search data sources',
                  }
                ),
        ...
        <EuiFlexGroup justifyContent="flexEnd">
          <EuiFlexItem grow={false}>
            <EuiSmallButton
              data-test-subj="createDatasetStepDataSourceNextStepButton"
              fill
              iconSide="right"
              iconType="arrowRight"
