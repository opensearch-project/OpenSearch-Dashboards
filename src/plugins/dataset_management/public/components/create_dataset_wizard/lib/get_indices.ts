...
const aliasLabel = i18n.translate('datasetManagement.aliasLabel', { defaultMessage: 'Alias' });
const dataStreamLabel = i18n.translate('datasetManagement.dataStreamLabel', {
  defaultMessage: 'Data stream',
});

const indexLabel = i18n.translate('datasetManagement.indexLabel', {
  defaultMessage: 'Index',
});

const frozenLabel = i18n.translate('datasetManagement.frozenLabel', {
  defaultMessage: 'Frozen',
});

export const searchResponseToArray =
  (getIndexTags: DatasetCreationConfig['getIndexTags'], showAllIndices: boolean) =>
...
export const getIndicesViaSearch = async ({
  ...
  getIndexTags: DatasetCreationConfig['getIndexTags'];
  pattern: string;
