    ...
    const columns = [
      fieldType === 'string'
        ? {
            ...
            name: (
              <FormattedMessage
                id="datasetManagement.color.patternLabel"
        ...
        : {
            ...
            name: (
              <FormattedMessage
                id="datasetManagement.color.rangeLabel"
          ...
          },
      {
        ...
        name: (
          <FormattedMessage
            id="datasetManagement.color.textColorLabel"
      ...
      },
      {
        ...
        name: (
          <FormattedMessage
            id="datasetManagement.color.backgroundLabel"
      ...
      {
        name: (
          <FormattedMessage id="datasetManagement.color.exampleLabel" defaultMessage="Example" />
        ),
      ...
      {
        field: 'actions',
        name: i18n.translate('datasetManagement.color.actions', {
          defaultMessage: 'Actions',
        }),
        actions: [
          {
            name: i18n.translate('datasetManagement.color.deleteAria', {
              defaultMessage: 'Delete',
            }),
            description: i18n.translate('datasetManagement.color.deleteTitle', {
    ...
    return (
      <Fragment>
        ...
        <EuiButton iconType="plusInCircle" size="s" onClick={this.addColor}>
          <FormattedMessage
            id="datasetManagement.color.addColorButton"
