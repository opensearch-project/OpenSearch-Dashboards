...
import { dataExplorerPluginMock } from '../../data_explorer/public/mocks';
  ...
  describe('setup', () => {
    it('initializes the plugin correctly and registers it as an alias visualization', () => {
      ...
      const pluginStartContract = {
        ...
        dataExplorer: dataExplorerPluginMock.createDataExplorerStartServicesMock(),
      };
      ...
      const setupDeps = {
        ...
        dataExplorer: dataExplorerPluginMock.createDataExplorerSetupServicesMock(),
