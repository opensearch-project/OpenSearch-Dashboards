 ...
 */
export function WizardFieldSearch({ onChange, value, types }: Props) {
  const searchPlaceholder = i18n.translate('wizard.fieldChooser.searchPlaceHolder', {
    defaultMessage: 'Search field names',
  });
  const aggregatableLabel = i18n.translate('wizard.fieldChooser.filter.aggregatableLabel', {
    defaultMessage: 'Aggregatable',
  });
  const searchableLabel = i18n.translate('wizard.fieldChooser.filter.searchableLabel', {
    defaultMessage: 'Searchable',
  });
  const typeLabel = i18n.translate('wizard.fieldChooser.filter.typeLabel', {
    defaultMessage: 'Type',
  });
  ...
  const filterBtnAriaLabel = isPopoverOpen
    ? i18n.translate('wizard.fieldChooser.toggleFieldFilterButtonHideAriaLabel', {
        defaultMessage: 'Hide field filter settings',
      })
    : i18n.translate('wizard.fieldChooser.toggleFieldFilterButtonShowAriaLabel', {
  ...
  const buttonContent = (
    <EuiFacetButton
      ...
      className="wizFieldSearch__toggleButton"
    ...
    >
      <FormattedMessage
        id="wizard.fieldChooser.fieldFilterFacetButtonLabel"
  ...
  const select = (
    ...
    return (
      <EuiSelect
        ...
        aria-label={i18n.translate('wizard.fieldChooser.filter.fieldSelectorLabel', {
  ...
  const selectionPanel = (
    <div className="wizFieldSearch__formWrapper">
  ...
  return (
    <React.Fragment>
      ...
      <div className="wizFieldSearch__filterWrapper">
        <EuiOutsideClickDetector onOutsideClick={() => {}} isDisabled={!isPopoverOpen}>
          ...
          >
            <EuiPopoverTitle>
              {i18n.translate('wizard.fieldChooser.filter.filterByTypeLabel', {
                defaultMessage: 'Filter by type',
              })}
            </EuiPopoverTitle>
            {selectionPanel}
            <EuiPopoverFooter>
              <EuiSwitch
                label={i18n.translate('wizard.fieldChooser.filter.hideMissingFieldsLabel', {
