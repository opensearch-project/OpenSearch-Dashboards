...
const writeFileMock = fsPromises.writeFile as jest.MockedFunction<typeof fsPromises.writeFile>;
const mkdirMock = fsPromises.mkdir as jest.MockedFunction<typeof fsPromises.mkdir>;
