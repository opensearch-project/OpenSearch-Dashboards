...
export const TEMPORARILY_IGNORED_PATHS = [
  ...
  'src/core/server/core_app/assets/favicons/android-chrome-heatmap-192x192.png',
  'src/core/server/core_app/assets/favicons/android-chrome-heatmap-256x256.png',
  'src/core/server/core_app/assets/favicons/android-chrome-heatmap-512x512.png',
  'src/core/server/core_app/assets/favicons/apple-touch-icon-heatmap.png',
  'src/core/server/core_app/assets/favicons/favicon-heatmap-16x16.png',
  'src/core/server/core_app/assets/favicons/favicon-heatmap-32x32.png',
  'src/core/server/core_app/assets/favicons/mstile-70x70.png',
  'src/core/server/core_app/assets/favicons/mstile-144x144.png',
  'src/core/server/core_app/assets/favicons/mstile-heatmap-150x150.png',
  'src/core/server/core_app/assets/favicons/mstile-310x150.png',
  'src/core/server/core_app/assets/favicons/mstile-310x310.png',
  'src/core/server/core_app/assets/favicons/safari-pinned-tab-heatmap.svg',
