...
export class OpenSearchSQLParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
   ...
   * @return the visitor result
   */
  visitAltSingleFieldRelevanceFunctionName?: (
    ctx: AltSingleFieldRelevanceFunctionNameContext
  ) => Result;
  /**
   ...
   * @return the visitor result
   */
  visitAltMultiFieldRelevanceFunctionName?: (
    ctx: AltMultiFieldRelevanceFunctionNameContext
  ) => Result;
  /**
