...
module.exports = defineConfig([
    ...
    // ── TypeScript files ─────────────────────────────────────────────────────
    {
        ...
        rules: {
            ...
            "@typescript-eslint/no-restricted-types": [
                "error",
                {
                    types: {
                        ...
                        StatelessComponent: { message: "Use FunctionComponent instead.", fixWith: "FunctionComponent" },
                        "React.StatelessComponent": { message: "Use FunctionComponent instead.", fixWith: "React.FunctionComponent" },
                    },
                },
            ],
            camelcase: "off",
            "@typescript-eslint/naming-convention": [
                "error",
                { selector: "default", format: ["camelCase"], filter: { regex: allowedNameRegexp, match: false } },
                { selector: "variable", format: ["camelCase", "UPPER_CASE", "PascalCase"], filter: { regex: allowedNameRegexp, match: false } },
                { selector: "parameter", format: ["camelCase", "PascalCase"], filter: { regex: allowedNameRegexp, match: false } },
                { selector: "memberLike", format: ["camelCase", "PascalCase", "snake_case", "UPPER_CASE"], filter: { regex: allowedNameRegexp, match: false } },
                { selector: "function", format: ["camelCase", "PascalCase"], filter: { regex: allowedNameRegexp, match: false } },
                { selector: "typeLike", format: ["PascalCase", "UPPER_CASE"], leadingUnderscore: "allow", trailingUnderscore: "allow" },
            ...
            "@typescript-eslint/explicit-member-accessibility": [
                "error",
                { accessibility: "off", overrides: { accessors: "explicit", constructors: "no-public", parameterProperties: "explicit" } },
            ],
            ...
            "no-restricted-syntax": [
                2,
                { selector: "CallExpression[callee.object.name='describe'][callee.property.name='only']", message: "No exclusive suites." },
                { selector: "CallExpression[callee.object.name='it'][callee.property.name='only']", message: "No exclusive tests." },
                { selector: "CallExpression[callee.object.name='test'][callee.property.name='only']", message: "No exclusive tests." },
            ],
    ...
    // ── @osd/eslint plugin + prettier (shared config top-level) ──────────────
    {
        ...
        rules: {
            ...
            "@osd/eslint/module_migration": ["error", [
                { from: "expect.js", to: "@osd/expect" },
                { from: "mkdirp", to: false, disallowedMessage: "Don't use 'mkdirp', use the new { recursive: true } option of Fs.mkdir instead" },
                { from: "numeral", to: "@elastic/numeral" },
                { from: "@osd/elastic-idx", to: false, disallowedMessage: "Don't use idx(), use optional chaining syntax instead https://ela.st/optchain" },
                { from: "react-router", to: "react-router-dom" },
                { from: "@osd/ui-shared-deps/monaco", to: "@osd/monaco" },
                { from: "monaco-editor", to: false, disallowedMessage: "Don't import monaco directly, use or add exports to @osd/monaco" },
            ]],
        },
    },
