...
// stateful deps
export const KbnI18n = require('@osd/i18n');
export const KbnI18nAngular = require('@osd/i18n/angular');
export const KbnI18nReact = require('@osd/i18n/react');
export const Angular = require('angular');
export const Moment = require('moment');
export const MomentTimezone = require('moment-timezone/moment-timezone');
export const KbnMonaco = require('@osd/monaco');
