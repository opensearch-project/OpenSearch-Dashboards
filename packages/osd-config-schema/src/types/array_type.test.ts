...
Cause: expected value of type [array] but got [number]"
`
  );
});
...
Cause: could not parse array value from json input"
`
  );
});
...
Cause: expected value of type [array] but got [Object]"
`
  );
});
...
Cause: sparse array are not allowed"
`
  );
});
...
describe('#minSize', () => {
  ...
  test('returns error when fewer items', () => {
    expect(() =>
      ...
      `
"array size is [1], but cannot be smaller than [2]
Cause: array size is [1], but cannot be smaller than [2]"
`
    );
  });
});
...
describe('#maxSize', () => {
  ...
  test('returns error when more items', () => {
    expect(() =>
      ...
      `
"array size is [2], but cannot be greater than [1]
Cause: array size is [2], but cannot be greater than [1]"
`
    );
  });
});
