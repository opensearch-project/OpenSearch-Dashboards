...
it('builds a generated plugin into a viable archive', async () => {
  ...
  expect(files).toMatchInlineSnapshot(`
    Array [
      ...
      "opensearch-dashboards/fooTestPlugin/target/public/fooTestPlugin.chunk.422.js",
      "opensearch-dashboards/fooTestPlugin/target/public/fooTestPlugin.chunk.422.js.br",
      "opensearch-dashboards/fooTestPlugin/target/public/fooTestPlugin.chunk.422.js.gz",
