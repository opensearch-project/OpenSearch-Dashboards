...
import {} from '../../test-utils/vitest.utilities';
import { renderHook, act } from '@testing-library/react';
import { CelestialNodeActionsProvider, useCelestialNodeActionsContext } from './NodeActionsContext';

const mockFitViewWithDelay = jest.fn();
jest.mock('../hooks/use-fit-view-with-delay.hook', () => ({
...
jest.mock('./CelestialStateContext', () => ({
