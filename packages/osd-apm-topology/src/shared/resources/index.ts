...
export { default as AlarmRecoveredIcon } from './alarm-recovered.svg';
export { default as CloseIcon } from './close.svg';
export { default as DividerIcon } from './divider.svg';
export { default as ExpandAllIcon } from './expand-all.svg';
export { default as FitViewIcon } from './fit-view.svg';
...
export { default as UninstrumentedGraphic } from './uninstrumented.svg';
