...
export class StateContainersExamplesPlugin implements Plugin {
  public setup(core: CoreSetup, { developerExamples }: SetupDeps) {
      ...
      links: [
        {
          label: 'README',
          href:
            'https://github.com/opensearch-project/OpenSearch-Dashboards/tree/master/src/plugins/opensearch-dashboards-utils/docs/state_containers/README.md',
          iconType: 'logoGithub',
          size: 's',
          target: '_blank',
        },
    ...
    developerExamples.register({
      ...
      description: `Shows how to use data.syncQueryStateWitUrl in combination  with state container utilities from opensearch-dashboards-utils to
