...
- [BUG][Multiple Datasource] Fix missing customApiRegistryPromise param for test connection ([#5943](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/5943))
