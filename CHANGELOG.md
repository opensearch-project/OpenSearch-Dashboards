...
- [BUG] Fixed --allow-root flag for root users ([#2607](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/2607))
...
- [BUG] Fix suggestion list cutoff issue ([#2607](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/2607))
 - [BUG] Fixes --allow-root flag as root user([#3666](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/3666))
