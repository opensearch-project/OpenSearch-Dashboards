...
- Add example demo plugins for cross compatibility service and functional tests ([#5896](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/5896))
