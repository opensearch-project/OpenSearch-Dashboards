...
- [Multiple Datasource] Add default icon for aggregated view and add default icon ([#6386](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/6386))
