...
- [CVE-2022-1537] Bump grunt from `1.5.2` to `1.5.3` ([#4726](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/4726))
...
- [Version] Increment to 1.3.10 ([#3632](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/3632))
