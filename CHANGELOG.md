...
- [TSVB] Replace jquery usage in vis_type_timeseries plugin with native methods ([#3682]https://github.com/opensearch-project/OpenSearch-Dashboards/issues/3682))
