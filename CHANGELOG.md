...
- [Doc] Update CONTRIBUTING.md: Add changelog info, First PR guide, Basic git commands guide, linking to ONBOARDING ([3794](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/3794))
