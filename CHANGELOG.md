...
- Introduce `registerRightNavigation` in chrome service to reigster standard top right navigation and add dev tool to top right navigation. ([#6553](https://github.com/opensearch-project/OpenSearch-Dashboards/pull/6553))
