...
* Upload GeoJSON files into OpenSearch.
...
[float]
=== Upload GeoJSON files into OpenSearch
Maps makes it easy to import geospatial data into the Elastic Stack. Using the GeoJSON Upload feature, you can drag and drop your point and shape data files directly into OpenSearch, and then use them as layers in the map.
