...
This image shows an example of static styling using the <<add-sample-data, OpenSearchDashboards sample web logs>> data set.
The *opensearch_dashboards_sample_data_logs* layer uses static styling for all properties.
...
This image shows an example of data driven styling using the <<add-sample-data, OpenSearchDashboards sample web logs>> data set.
The *opensearch_dashboards_sample_data_logs* layer uses data driven styling for fill color and symbol size style properties.
...
For example, let's symbolize <<add-sample-data, OpenSearchDashboards sample web log>> documents by size.
...
This image shows an example of quantitative data driven styling using the <<add-sample-data, OpenSearchDashboards sample web logs>> data set.
...
This image shows an example of class styling using the <<add-sample-data, OpenSearchDashboards sample web logs>> data set.
