...
WARNING: In 7.x, you’ll no longer see the Timelion application in the {osd} 
...
opensearch_dashboards.yml file. In 8.0, the Timelion application will be deprecated. When 
you upgrade from {osd} 7.x to 8.0, your Timelion sheets will be migrated to Timelion visualization objects.
...
* https://www.elastic.co/videos/timelion-plugin-for-opensearch-dashboards-enables-times-series-paris-meetup[Timelion Plugin for OpenSearchDashboards Enables Time Series]
* https://www.elastic.co/videos/using-opensearch-dashboards-and-timelion-to-analyze-earthquake-data[Using OpenSearchDashboards and Timelion to Analyze Earthquake Data]
--
