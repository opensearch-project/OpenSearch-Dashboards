...
See
{opensearch-dashboards-ref}/action-types.html[Action and connector types].
// end::action-def[]
--

[[glossary-advanced-settings]] Advanced Settings ::
// tag::advanced-settings-def[]
Enables you to control the appearance and behavior of {osd}
by setting the date format, default index, and other attributes.
Part of {osd} Stack Management.
See {opensearch-dashboards-ref}/advanced-options.html[Advanced Settings].
...
manage alerts for all {osd} apps from one place.
See {opensearch-dashboards-ref}/alerting-getting-started.html[Alerts and Actions].
...
[[glossary-app]] app ::
// tag::app-def[]
A top-level {osd} component that is accessed through the side navigation.
Apps include core {osd} components such as Discover and Dashboard,
...
// tag::bucket-def[]
A set of documents in {osd} that have certain characteristics in common.
...
// tag::canvas-def[]
Enables you to create presentations and infographics that pull live data directly from {opensearch}.
See {opensearch-dashboards-ref}/canvas.html[Canvas].
// end::canvas-def[]
...
See {opensearch-dashboards-ref}/canvas-function-reference.html[Canvas function reference].
...
See {opensearch-dashboards-ref}/action-types.html[Action and connector types].
// end::connector-def[]

[[glossary-console]] Console ::
// tag::console-def[]
A tool for interacting with the {opensearch} REST API.
You can send requests to {opensearch}, view responses,
view API documentation, and get your request history.
See {opensearch-dashboards-ref}/console-opensearch-dashboards.html[Console].
// end::console-def[]
...
might have a drilldown to a dashboard for a single data center. See {opensearch-dashboards-ref}/dashboard.html[Drilldowns].
// end::drilldown-def[]
...
{opensearch-dashboards-ref}/xpack-graph.html[Graph].
// end::edge-def[]
...
{opensearch-dashboards-ref}//xpack-spaces.html#spaces-control-feature-visibility[Feature Controls].
...
nodes are represented by <<glossary-edge,edges>>.  See {opensearch-dashboards-ref}/xpack-graph.html[Graph].
// end::graph-def[]
...
{opensearch-dashboards-ref}/xpack-grokdebugger.html[Debugging grok expressions].
...
[[glossary-opensearch-dashboards-privileges]] {osd} privileges ::
// tag::opensearch-dashboards-privileges-def[]
Enable administrators to grant users read-only, read-write, or no access to 
individual features within <<glossary-space,spaces>> in {osd}. See
{opensearch-dashboards-ref}/opensearch-dashboards-privileges.html[{osd} privileges].
// end::opensearch-dashboards-privileges-def[]

[[glossary-kql]] {osd} Query Language (KQL) ::
// tag::kql-def[]
The default language for querying in {osd}. KQL provides
support for scripted fields. See
{opensearch-dashboards-ref}/kuery-query.html[OpenSearchDashboards Query Language].
// end::kql-def[]
...
See {opensearch-dashboards-ref}/dashboard.html[Lens].
// end::lens-def[]


[[glossary-lucene]] Lucene query syntax ::
// tag::lucene-def[]
The query syntax for {osd}’s legacy query language. The Lucene query
...
See {opensearch-dashboards-ref}/maps.html[Maps].
// end::map-def[]
...
See {opensearch-dashboards-ref}/painlesslab.html[Painless Lab].
...
See {opensearch-dashboards-ref}/xpack-profiler.html[Query Profiler].
...
A field that computes data on the fly from the data in {opensearch} indices.
...
See
{opensearch-dashboards-ref}/xpack-spaces.html[Spaces].
// end::space-def[]

[[glossary-stack-alerts]] stack alerts ::
// tag::stack-alert-def[]
The general purpose alert types {osd} provides out of the box.  Index threshold and geo alerts are currently the two stack alert types.
// end::stack-alert-def[]
...
See {opensearch-dashboards-ref}/dashboard.html[TSVB].
// end::tsvb-def[]
...
{opensearch}. The assistant identifies the deprecated settings in your cluster and
indices and guides you through resolving issues, including reindexing. See
{opensearch-dashboards-ref}/upgrade-assistant.html[Upgrade Assistant].
...
See {opensearch-dashboards-ref}/dashboard.html[Vega].
// end::vega-def[]
...
A graphical representation of query results in {osd} (e.g., a histogram, line graph, pie chart, or heat map).
...
See
{opensearch-dashboards-ref}/watcher-ui.html[Watcher].
// end::watcher-def[]
...
See
{opensearch-dashboards-ref}/canvas.html[Create a workpad].
// end::workpad-def[]
