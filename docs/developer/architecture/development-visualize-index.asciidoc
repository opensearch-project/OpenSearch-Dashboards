...
[IMPORTANT]
==============================================
These pages document internal APIs and are not guaranteed to be supported across future versions of {osd}.
==============================================

The internal APIs for creating custom visualizations are in a state of heavy churn as
they are being migrated to the new {osd} platform, and large refactorings have been
...
* link:https://github.com/elastic/opensearch-dashboards/issues/44121[Meta issue] which is tracking the move of the plugin to the new {osd} platform
* Our link:https://www.elastic.co/blog/join-our-elastic-stack-workspace-on-slack[Elastic Stack workspace on Slack].
* The {osd-repo}blob/{branch}/src/plugins/visualizations[source code], which will continue to be
