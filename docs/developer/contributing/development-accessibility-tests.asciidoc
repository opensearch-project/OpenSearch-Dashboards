...
export default function ({ getService, getPageObjects }) {
  ...
  describe('OpenSearchDashboards Home', () => {
    before(async () => {
      await common.navigateToApp('home'); /* navigates to the page we want to test */
    });

    it('OpenSearchDashboards Home view', async () => {
      await retry.waitFor(
        'home page visible',
     ...
     */
    // Skipped due to https://github.com/elastic/opensearch-dashboards/issues/99999
    it.skip('all plugins view page meets a11y requirements', async () => {
      await home.clickAllOpenSearchDashboardsPlugins();
     ...
     */
    it('Add OpenSearchDashboards sample data page', async () => {
