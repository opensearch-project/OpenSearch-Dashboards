...
https://github.com/elastic/opensearch-dashboards/blob/master/.editorconfig[`.editorconfig`]
...
maintaining the {osd} project. Formatting and styling roles are set in
