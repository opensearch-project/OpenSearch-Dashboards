...
{osd} is migrating unit testing from `Mocha` to `Jest`. Legacy unit tests
...
https://github.com/elastic/opensearch-dashboards/tree/master/packages/osd-plugin-generator[OpenSearchDashboards
