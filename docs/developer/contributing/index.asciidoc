...
* <<opensearch-dashboards-issue-reporting>>
* <<signing-contributor-agreement>>
* <<opensearch-dashboards-localization>>
* <<opensearch-dashboards-release-notes-process>>
* <<opensearch-dashboards-linting>>
...
Read <<opensearch-dashboards-localization-best-practices>> for details on our localization practices.
...
{osd} publishes https://www.elastic.co/guide/en/opensearch-dashboards/current/release-notes.html[Release Notes] for major and minor releases. 
...
To use a single paragraph of text, enter a `Release note:` or `## Release note` header in the PR description ("dev docs" works too), followed by your text. For example, refer to this https://github.com/elastic/opensearch-dashboards/pull/65796[PR] that uses the `## Release note` header.
...
include::opensearch-dashboards-issue-reporting.asciidoc[leveloffset=+1]
