...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-public](./opensearch-dashboards-plugin-core-public.md) &gt; [AppMountContext](./opensearch-dashboards-plugin-core-public.appmountcontext.md)
...
The context object received when applications are mounted to the DOM. Deprecated, use [CoreSetup.getStartServices](./opensearch-dashboards-plugin-core-public.coresetup.getstartservices.md)<!-- -->.
