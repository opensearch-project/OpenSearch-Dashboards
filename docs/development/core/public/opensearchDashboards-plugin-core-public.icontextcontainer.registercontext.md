...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-public](./opensearch-dashboards-plugin-core-public.md) &gt; [IContextContainer](./opensearch-dashboards-plugin-core-public.icontextcontainer.md) &gt; [registerContext](./opensearch-dashboards-plugin-core-public.icontextcontainer.registercontext.md)
...
|  provider | <code>IContextProvider&lt;THandler, TContextName&gt;</code> | A [IContextProvider](./opensearch-dashboards-plugin-core-public.icontextprovider.md) to be called each time a new context is created. |

<b>Returns:</b>

`this`

The [IContextContainer](./opensearch-dashboards-plugin-core-public.icontextcontainer.md) for method chaining.
