...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-public](./opensearch-dashboards-plugin-core-public.md) &gt; [IContextContainer](./opensearch-dashboards-plugin-core-public.icontextcontainer.md)
...
In order to configure a handler with context, you must call the [IContextContainer.createHandler()](./opensearch-dashboards-plugin-core-public.icontextcontainer.createhandler.md) function and use the returned handler which will automatically build a context object when called.
...
|  Method | Description |
|  --- | --- |
|  [createHandler(pluginOpaqueId, handler)](./opensearch-dashboards-plugin-core-public.icontextcontainer.createhandler.md) | Create a new handler function pre-wired to context for the plugin. |
|  [registerContext(pluginOpaqueId, contextName, provider)](./opensearch-dashboards-plugin-core-public.icontextcontainer.registercontext.md) | Register a new context provider. |
