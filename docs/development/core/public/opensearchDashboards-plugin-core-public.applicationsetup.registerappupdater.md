...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-public](./opensearch-dashboards-plugin-core-public.md) &gt; [ApplicationSetup](./opensearch-dashboards-plugin-core-public.applicationsetup.md) &gt; [registerAppUpdater](./opensearch-dashboards-plugin-core-public.applicationsetup.registerappupdater.md)

## ApplicationSetup.registerAppUpdater() method

Register an application updater that can be used to change the [AppUpdatableFields](./opensearch-dashboards-plugin-core-public.appupdatablefields.md) fields of all applications at runtime.
