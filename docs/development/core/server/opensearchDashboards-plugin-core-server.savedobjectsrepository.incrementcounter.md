...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObjectsRepository](./opensearch-dashboards-plugin-core-server.savedobjectsrepository.md) &gt; [incrementCounter](./opensearch-dashboards-plugin-core-server.savedobjectsrepository.incrementcounter.md)
