...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObjectsRepository](./opensearch-dashboards-plugin-core-server.savedobjectsrepository.md) &gt; [checkConflicts](./opensearch-dashboards-plugin-core-server.savedobjectsrepository.checkconflicts.md)
