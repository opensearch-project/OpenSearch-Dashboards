...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [LoggingServiceSetup](./opensearch-dashboards-plugin-core-server.loggingservicesetup.md) &gt; [configure](./opensearch-dashboards-plugin-core-server.loggingservicesetup.configure.md)
