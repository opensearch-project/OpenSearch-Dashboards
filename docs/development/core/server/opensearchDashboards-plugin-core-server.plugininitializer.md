...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [PluginInitializer](./opensearch-dashboards-plugin-core-server.plugininitializer.md)
