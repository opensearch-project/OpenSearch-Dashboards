...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObjectsFindOptions](./opensearch-dashboards-plugin-core-server.savedobjectsfindoptions.md) &gt; [typeToNamespacesMap](./opensearch-dashboards-plugin-core-server.savedobjectsfindoptions.typetonamespacesmap.md)
