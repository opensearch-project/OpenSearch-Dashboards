...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObject](./opensearch-dashboards-plugin-core-server.savedobject.md) &gt; [originId](./opensearch-dashboards-plugin-core-server.savedobject.originid.md)
