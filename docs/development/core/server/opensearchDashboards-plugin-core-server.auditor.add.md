...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [Auditor](./opensearch-dashboards-plugin-core-server.auditor.md) &gt; [add](./opensearch-dashboards-plugin-core-server.auditor.add.md)
