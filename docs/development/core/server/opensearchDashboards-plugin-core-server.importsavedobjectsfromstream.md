...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [importSavedObjectsFromStream](./opensearch-dashboards-plugin-core-server.importsavedobjectsfromstream.md)

## importSavedObjectsFromStream() function

Import saved objects from given stream. See the [options](./opensearch-dashboards-plugin-core-server.savedobjectsimportoptions.md) for more detailed information.
