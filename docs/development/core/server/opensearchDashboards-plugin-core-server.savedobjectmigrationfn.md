...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObjectMigrationFn](./opensearch-dashboards-plugin-core-server.savedobjectmigrationfn.md)

## SavedObjectMigrationFn type

A migration function for a [saved object type](./opensearch-dashboards-plugin-core-server.savedobjectstype.md) used to migrate it to a given version
