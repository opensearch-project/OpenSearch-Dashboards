...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [CapabilitiesSetup](./opensearch-dashboards-plugin-core-server.capabilitiessetup.md) &gt; [registerSwitcher](./opensearch-dashboards-plugin-core-server.capabilitiessetup.registerswitcher.md)

## CapabilitiesSetup.registerSwitcher() method

Register a [CapabilitiesSwitcher](./opensearch-dashboards-plugin-core-server.capabilitiesswitcher.md) to be used to change the default state of the [Capabilities](./opensearch-dashboards-plugin-core-server.capabilities.md) entries when resolving them.
