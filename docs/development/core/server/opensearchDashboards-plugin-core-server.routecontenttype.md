...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [RouteContentType](./opensearch-dashboards-plugin-core-server.routecontenttype.md)
