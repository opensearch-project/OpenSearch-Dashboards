...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [RouteConfigOptionsBody](./opensearch-dashboards-plugin-core-server.routeconfigoptionsbody.md) &gt; [parse](./opensearch-dashboards-plugin-core-server.routeconfigoptionsbody.parse.md)
