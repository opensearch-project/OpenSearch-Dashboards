...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [PluginManifest](./opensearch-dashboards-plugin-core-server.pluginmanifest.md) &gt; [requiredBundles](./opensearch-dashboards-plugin-core-server.pluginmanifest.requiredbundles.md)
