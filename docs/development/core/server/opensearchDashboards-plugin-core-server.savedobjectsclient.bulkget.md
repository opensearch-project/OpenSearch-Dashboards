...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [SavedObjectsClient](./opensearch-dashboards-plugin-core-server.savedobjectsclient.md) &gt; [bulkGet](./opensearch-dashboards-plugin-core-server.savedobjectsclient.bulkget.md)
