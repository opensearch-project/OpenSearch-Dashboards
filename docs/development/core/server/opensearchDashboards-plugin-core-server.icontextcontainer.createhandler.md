...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [IContextContainer](./opensearch-dashboards-plugin-core-server.icontextcontainer.md) &gt; [createHandler](./opensearch-dashboards-plugin-core-server.icontextcontainer.createhandler.md)
