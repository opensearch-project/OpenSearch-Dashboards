...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [LifecycleResponseFactory](./opensearch-dashboards-plugin-core-server.lifecycleresponsefactory.md)
