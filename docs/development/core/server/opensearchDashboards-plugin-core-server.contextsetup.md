...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-core-server](./opensearch-dashboards-plugin-core-server.md) &gt; [ContextSetup](./opensearch-dashboards-plugin-core-server.contextsetup.md)
...
|  Method | Description |
|  --- | --- |
|  [createContextContainer()](./opensearch-dashboards-plugin-core-server.contextsetup.createcontextcontainer.md) | Creates a new [IContextContainer](./opensearch-dashboards-plugin-core-server.icontextcontainer.md) for a service owner. |
