...
[Home](./index.md) &gt; [opensearch-dashboards-plugin-plugins-data-server](./opensearch-dashboards-plugin-plugins-data-server.md) &gt; [OPENSEARCH\_FIELD\_TYPES](./opensearch-dashboards-plugin-plugins-data-server.opensearch_dashboards_field_types.md)
