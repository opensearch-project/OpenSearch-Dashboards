...
manage configurations in a central location in {osd} and quickly deploy
...
{osd} makes it easy for you to use central management by walking you through the
...
NOTE: Central management supports the following outputs only: {opensearch}, {ls}, Kafka,
