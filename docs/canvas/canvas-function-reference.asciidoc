...
escount "currency:"EUR"" index="opensearch_dashboards_sample_data_ecommerce"
...
esdocs "currency:"EUR"" index="opensearch_dashboards_sample_data_ecommerce"
...
----
filters
| esdocs index="opensearch_dashboards_sample_data_ecommerce"
