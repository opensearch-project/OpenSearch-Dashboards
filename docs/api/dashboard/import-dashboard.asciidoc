...
`POST <opensearchDashboards host>:<port>/api/opensearch-dashboards/dashboards/import`

`POST <opensearchDashboards host>:<port>/s/<space-id>/api/opensearch-dashboards/dashboards/import`
...
[source,sh]
--------------------------------------------------
$ curl -X POST api/opensearch-dashboards/dashboards/import?exclude=index-pattern
{
  "objects": [
    {
