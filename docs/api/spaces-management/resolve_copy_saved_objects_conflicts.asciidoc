...
`POST <opensearchDashboards host>:<port>/api/spaces/_resolve_copy_saved_objects_errors`

`POST <opensearchDashboards host>:<port>/s/<space_id>/api/spaces/_resolve_copy_saved_objects_errors`
