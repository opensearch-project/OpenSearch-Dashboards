...
Access to individual features is governed by {opensearch} and {osd} privileges.
...
|Use transforms to pivot existing {opensearch} indices into summarized or entity-centric indices.
...
| Centrally manage your alerts across {osd}. Create and manage reusable
...
|Create and manage the index patterns that retrieve your data from {opensearch}.
...
| Customize {osd} to suit your needs. Change the format for displaying dates, turn on dark mode,
...
next major version of {opensearch}, and then reindex, if needed.
...
include::{osd-repo-dir}/management/advanced-options.asciidoc[]

include::{osd-repo-dir}/management/alerting/alerts-and-actions-intro.asciidoc[]

include::{osd-repo-dir}/management/alerting/alert-management.asciidoc[]

include::{osd-repo-dir}/management/alerting/alert-details.asciidoc[]

include::{osd-repo-dir}/management/alerting/connector-management.asciidoc[]

include::{osd-repo-dir}/management/managing-beats.asciidoc[]

include::{osd-repo-dir}/management/ingest-pipelines/ingest-pipelines.asciidoc[]

include::{osd-repo-dir}/management/managing-fields.asciidoc[]

include::{osd-repo-dir}/management/managing-licenses.asciidoc[]

include::{osd-repo-dir}/management/numeral.asciidoc[]

include::{osd-repo-dir}/management/rollups/create_and_manage_rollups.asciidoc[]

include::{osd-repo-dir}/management/managing-saved-objects.asciidoc[]

include::security/index.asciidoc[]

include::{osd-repo-dir}/management/snapshot-restore/index.asciidoc[]

include::{osd-repo-dir}/spaces/index.asciidoc[]

include::{osd-repo-dir}/management/upgrade-assistant/index.asciidoc[]

include::{osd-repo-dir}/management/watcher-ui/index.asciidoc[]
