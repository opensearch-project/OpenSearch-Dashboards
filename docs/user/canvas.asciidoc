...
* Pull your data directly from OpenSearch, then show it off with charts, graphs, progress monitors, and more.
...
Each of the {osd} sample data sets comes with a workpad that you can use for your own workpad inspiration.

. Add a {opensearch-dashboards-ref}/add-sample-data.html[sample data set].
...
* *{opensearch} SQL* &mdash; Access your data in {opensearch} using {ref}/sql-spec.html[SQL syntax].
...
. Click *Add element > Add from {osd}*.
...
include::{osd-repo-dir}/canvas/canvas-edit-workpads.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-present-workpad.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-share-workpad.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-tutorial.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-expression-lifecycle.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-function-reference.asciidoc[]

include::{osd-repo-dir}/canvas/canvas-tinymath-functions.asciidoc[]
