[[space-rbac-tutorial]]
=== Tutorial: Use role-based access control to customize OpenSearchDashboards spaces

With role-based access control (RBAC), you can provide users access to data, tools,
and OpenSearchDashboards spaces.  In this tutorial, you will learn how to configure roles
that provide the right users with the right access to the data, tools, and
OpenSearchDashboards spaces.
...
https://www.elastic.co/guide/en/opensearch/reference/current/security-privileges.html[security privileges] documentation.
...
By default, roles do not give OpenSearchDashboards privileges.  Click **Add space
