...
The index action type will index a document into {opensearch}. See also the {ref}/indices-create-index.html[create index API].
...
Index::     The {opensearch} index to be written to.
