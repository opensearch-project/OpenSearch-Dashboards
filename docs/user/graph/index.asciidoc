...
and an interactive graph visualization tool for OpenSearchDashboards. Both work out of the
...
But what about performance, you ask? The OpenSearch aggregation framework
